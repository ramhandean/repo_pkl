...
<body>
	<nav class="navbar-nav navbar-expand navbar-dark bg-dark p-2">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a class="nav-link btn btn-secondary font-weight-bold text-dark" href="<?php echo site_url('C_user/pesananBarang') ?>">Kembali</a>
			</li>
		</ul>
			...
			<tbody>
				...
				foreach ($data as $d): ?>
					<tr align="center">
						...
						<td>
							<a class="btn btn-success" href="<?php echo site_url('C_user/konfirmasi_pesanan/'.$d['id_transaksi']) ?>">Konfirmasi Telah Diterima</a>
						</td>
					</tr>
				<?php
				$i = $i+1;
